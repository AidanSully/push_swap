...
echo "${YELLOW}VAL='1 2 3' \t\tCMD='   sa   pb   pa'\t:${EOC}"
VAL="1 2 3";
CMD="sa \n pb \n pa";
echo $CMD | ./checker $VAL
...
echo "${YELLOW}VAL='' \t\t\tCMD=''\t\t('Usage' expected):\n${EOC}"
VAL="";
CMD="";
echo $CMD | ./checker $VAL
...
echo "${GREEN}\nSimple Test - 3 Numbers (3 or less instructions to pass)\n${EOC}"
...
echo "${GREEN}\nSimple Test - 5 Numbers (12 or less instructions to pass)\n${EOC}"
...
echo "${GREEN}\nMedium Test - 100 Numbers (700 or less instructions expected for full points)\n${EOC}"
...
echo "${GREEN}\nAdvanced Test - 500 Numbers (5500 or less instructions expected for full points)\n${EOC}"
...
echo "${GREEN}Bonus Test - (options -v -c -t -vs for push_swap and options -v -c -t for checker\n${EOC}";

VAL="`ruby -e 'printf Array.new(5) { rand(-999999...999999) }.uniq.map { |i| i.to_s}.join(" ")'`";
echo "${YELLOW}VAL - random 5 BONUS -v\t:${EOC}"
echo $VAL | ./push_swap $VAL | wc -l
echo "${YELLOW}Push_swap\t:${EOC}"
./push_swap -v $VAL
echo "${YELLOW}Checker\t:${EOC}"
./push_swap $VAL | ./checker -v $VAL

echo "${YELLOW}VAL - random 5 BONUS -c\t:${EOC}"
echo $VAL | ./push_swap $VAL | wc -l
echo "${YELLOW}Push_swap\t:${EOC}"
./push_swap -v -c $VAL
echo "${YELLOW}Checker\t:${EOC}"
./push_swap $VAL | ./checker -v -c $VAL

echo "${YELLOW}VAL - random 5 BONUS -t\t:${EOC}"
echo $VAL | ./push_swap $VAL | wc -l
echo "${YELLOW}Push_swap\t:${EOC}"
./push_swap -t $VAL
echo "${YELLOW}Checker\t:${EOC}"
./push_swap $VAL | ./checker -t $VAL

# echo "${YELLOW}VAL - random 5 BONUS -vs\t:${EOC}"
# echo $VAL | ./push_swap $VAL | wc -l
# echo "${YELLOW}Push_swap\t:${EOC}"
# ./push_swap -vs $VAL
